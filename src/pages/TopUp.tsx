...
import { mockPointsPacks, diamondYearlyPriceUSD } from '@/data/mock';
...
export default function TopUp() {
  ...
  const handleBuyPack = (pack: typeof mockPointsPacks[0]) => {
    toast.success(`تم شراء ${pack.points} نقطة بنجاح! 🎉`);
    updateBalance(pack.points);
  };

  const handleBuyDiamond = () => {
    toast.success('تم تفعيل اشتراك Diamond لمدة سنة! 💎');
  };
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6">
          ...
          <div className="text-center sm:text-left">
            <p className="text-4xl font-black">${diamondYearlyPriceUSD}</p>
